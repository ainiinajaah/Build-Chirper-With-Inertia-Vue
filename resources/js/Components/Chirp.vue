...
import Upload from '@/Components/Upload.vue'; // Impor komponen Upload
...
<template>
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            ...
            <!-- Form untuk Edit -->
            <form v-if="editing" @submit.prevent="form.put(route('chirps.update', chirp.id), { onSuccess: () => editing = false })" enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    ...
                    <input type="file" @change="(e) => form.image = e.target.files[0]" class="mt-1 block w-full text-gray-900 border-gray-300 rounded-md shadow-sm">
                </div>
            ...
            <img v-if="chirp.image" :src="`/storage/${chirp.image}`" alt="Chirp Image" class="mt-4 rounded-lg shadow-md" />
